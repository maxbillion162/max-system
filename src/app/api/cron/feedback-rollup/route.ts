...
const TYPE_LABELS: Record<string, string> = {
  ...
  email_classification: "smart-folder classification of an email (action/waiting/newsletter/fyi/noise)",
  email_why_important: "the 'why this matters' line shown next to an email summary",
  whatif_narrative:   "Claude's one-line narrative on what-if scenarios in finance",
  money_dna:          "Claude's 6-month spending personality patterns",
  subscription_audit: "Claude's cancel/keep/negotiate suggestions on detected subscriptions",
  quarterly_narrative: "the quarterly auto-narrative report on the Finance page",
